...
private
{
    ...
    {
        version(X86_64)
            enum libNames = "libcudnn.6.dylib,libcudnn.dylib";
        else
            static assert(0, "There are no cuDNN libNames for this arch and operating system.");
    }
    else
...
__gshared DerelictCuDNN6Loader DerelictCuDNN6;

shared static this()
{
    DerelictCuDNN6 = new DerelictCuDNN6Loader();
}
